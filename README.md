...
## 🗺️ 로드맵 (Roadmap)
Simple To-Do List 프로젝트는 최종적으로 백엔드 API 연동을 위한 FE 구조를 완성하고 Netlify 서비스를 이용해 호스팅하는 것을 목표로 합니다.
...
### 🛠️ v0.1.0 작업 목록
- [x] HTML 시맨틱 구조 작성
- [x] 웹 접근성을 고려하여 HTML 업데이트
- [x] 페이지 메타 정보 추가
- [x] 아이콘 추가
- [ ] 오픈 그래프 메타 정보 추가
- [ ] PWA(Progressive Web Application) 메타 정보 추가
- [ ] 페이지 스타일링
- [ ] 반응형 스타일링 추가
